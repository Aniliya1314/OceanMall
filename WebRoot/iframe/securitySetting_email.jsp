	...
	<div class="container">
		<div class="row">
			<div class="col-md-2" style="margin-top:10px;">
				<ul class="nav">
					<li class="nav-list"><a href="javascript:void(0)" onclick="Personal()"
						class="nav-link active"> <i class="glyphicon glyphicon-home">&nbsp;个人中心</i>
					</a></li>
					<li class="nav-list"><a href="#systemSetting" id="change" class="nav-link active" data-toggle="collapse"> 
					...
					、<span id="spanleft" class="pull-right glyphicon glyphicon-chevron-left"></span>
						...
						<ul id="systemSetting" class="nav nav-list collapse secondmenu"
							...
							<li><a href="orderManager.jsp"><i
									class="glyphicon glyphicon-th-list">&nbsp;订单管理</i></a></li>
							<li><a href="myCollection.jsp"><i
			...
			<div class="col-md-10" style="margin-top:10px;">
				<div class="col-md-12" style="padding:0px;margin-top:10px;">
					...
					<div class="col-md-2">
						<a href="securitySetting.jsp" class="pull-right"
							style="color:#fe4d53;"><i
				...
				<div class="col-md-12" style="margin:20px 0px;">
					<form>
						...
						<div class="form-group col-md-8">
							<input name="check" type="text" class="form-control"
								placeholder="输入验证码">
						</div>
						<div class="col-md-2 form-group">
							<button class="btn btn-success form-control" type="button">获取验证码</button>
						</div>
						<div class="form-group col-md-10">
