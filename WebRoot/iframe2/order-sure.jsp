			...
			<form target="_blank" action="#" id="pay-form" method="post">
				<div class="order-info">
					...
					<div class="info">
						...
						<p>
							配送：庞石 <span class="line">/</span> 177****7777 <span class="line">/</span>
							湖南,湘潭市,韶山市  清溪镇清溪村民组36号 <span class="line">/</span> 不限送货时间 <span
								class="line">/</span>
						</p>
					</div>
					<div class="icon-box">
				...
				<div class="xm-plain-box">
											...
											<ul class="payment-list clearfix">
												<li><input class="input_tab1" name="myradio" id="r1"
													type="radio" checked="checked" /><label for="r1"><img
														src="img/xhw.png" alt="" /></label></label></li>
														...
														<div class="xhw">
															<div class="whx_banner">
																<div style="clear:both">
																	<p class="p1">请选择会员卡：</p>
																	<p class="p2">对不起，没有可用的会员卡！</p>
																	<a class="a3" href="#">立即去充值</a>
																</div>
																<div style="clear:both">
																	<p class="p1">已绑定手机号：</p>
																	<p class="a3">17773298909</p>
																</div>
																<div style="clear:both">
																	<p class="p1">短信效验码</p>
					...
					<div class="box-ft clearfix">
						<input type="submit" class="btn btn-primary" value="下一步"
							id="payBtn"/> <a href="#" class="btn btn-lineDakeLight">修改订单</a>
							<span class="tip"></span>
					</div>
				</div>
			</form>
				...
				<input type="text" name="verifycode" id="verifycode" class="input"
					...
					<p>
						<input type="button" value="确认支付" class="btn btn-primary"
							...
							</div> <a href="javascript:;" id="chooseOther">选择其他方式支付&gt;</a>
			</div>
		</div>
