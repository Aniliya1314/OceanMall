	...
	<div class="row">
			...
			<ul class="nav">
				...
				<li class="nav-list">
					...
					<ul id="systemSetting1" class="nav nav-list collapse secondmenu" style="text-align:center;">
                           ...
                           <li><a href="#" class="alwayslight"><i class="glyphicon glyphicon-exclamation-sign">&nbsp;安全设置</i></a></li>
		...
		<div class="col-md-10" style="margin-top:10px;">
			 <div class="col-md-12" style="padding:0px;margin-top:10px;">
			 	...
			 	<div class="col-md-2">
			 		<a href="securitySetting.jsp" class="pull-right" style="color:#fe4d53;"><i class="glyphicon glyphicon-share-alt"></i>返回</a>
			 	</div>	    		
             </div>
        	<div class="col-md-12" style="margin:20px 0px;">
        		<form>
 					<div class="form-group col-md-10">
    					...
    					<input type="text" class="form-control" id="mobile" value="132***028" disabled>
  					</div>  					
  					<div class="col-md-12">
  						<label>验证码</label>
  					</div>  					
  					<div class="form-group col-md-8">    					  				
  						<input name="check" type="text" class="form-control" placeholder="输入验证码">	 						 						
  					</div>
  					<div class="col-md-2 form-group">
  						<button class="btn btn-success form-control" type="button">获取验证码</button> 
  					</div>  										
  					<div class="form-group col-md-10">    					
   						<input type="submit" class="form-control btn btn-danger" value="确认">   						
  					</div>
  					<div class="form-group col-md-10">		
